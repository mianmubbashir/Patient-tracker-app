...
export default function Getstart({navigation}) {
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={{fontWeight:'bold',alignItems:'center', justifyContent: 'center', backgroundColor:"#0000FF", height: 40, marginLeft: 100, marginBottom: 50}} onPress={()=>{navigation.replace('Login')}}>
